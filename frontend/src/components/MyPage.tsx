...
export function MyPage() {
  ...
  const [vipLabel, setVipLabel] = useState<string>('New Member');
    ...
    <div className="pb-16 bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 min-h-screen">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative px-6 pt-8 pb-20">
          ...
          {/* Premium User Card with Glassmorphism */}
          <motion.div 
            initial={{ y: 30, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 0.3, type: "spring", stiffness: 100 }}
            className="bg-white/95 backdrop-blur-xl rounded-[2rem] p-6 shadow-2xl border border-white/50"
          >
