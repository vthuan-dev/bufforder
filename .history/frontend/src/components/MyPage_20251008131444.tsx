    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="p-4 space-y-4 max-w-sm mx-auto">
          ...
          {/* Mobile-First Add Address Modal */}
          {showAddForm && (
            <div
              className={`fixed inset-0 bg-black/50 backdrop-blur-sm flex items-start justify-center pt-16 p-4 z-50 transition-all duration-300 ${isClosing ? 'opacity-0' : 'opacity-100'}`}
              onClick={handleCloseForm}
            >
              <div
                className={`bg-white rounded-2xl w-full max-w-sm shadow-2xl border border-gray-200 transform transition-all duration-300 ease-out ${
                  isClosing
              ...
              >
                {/* Header */}
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-5 rounded-t-2xl border-b border-blue-500">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={handleCloseForm}
                      className="w-9 h-9 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-colors border border-white/20"
                    >
                ...
                {/* Form */}
                <div className="p-5 space-y-5 max-h-[60vh] overflow-y-auto border-b border-gray-100">
                  {/* Full Name */}
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3.5 bg-gray-50 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-sm font-medium hover:border-gray-300"
                      />
                ...
                {/* Action Buttons */}
                <div className="p-5 bg-gradient-to-r from-gray-50 to-gray-100 rounded-b-2xl">
                  <div className="flex space-x-3">
                    <button
                      className="flex-1 px-5 py-3.5 bg-white border-2 border-gray-300 text-gray-700 font-bold rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 text-sm shadow-sm"
                      onClick={handleCloseForm}
                    >
                      Cancel
                    </button>
                    <button
                      className="flex-1 px-5 py-3.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg disabled:opacity-50 text-sm transform hover:scale-105 active:scale-95"
