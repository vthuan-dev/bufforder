  ...
  const ModernProfileHeader = () => {
    ...
    return (
      <div className="relative mb-6 overflow-hidden">
        ...
        <div className="relative bg-gradient-to-br from-blue-500 via-purple-500 to-blue-600 rounded-2xl p-6 shadow-2xl overflow-hidden border border-white/30">
          {/* Glassmorphism overlay */}
          <div className="absolute inset-0 bg-white/10 backdrop-blur-sm rounded-2xl ring-1 ring-inset ring-white/30 pointer-events-none"></div>
