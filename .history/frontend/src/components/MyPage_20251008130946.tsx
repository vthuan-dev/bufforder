    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="p-4 space-y-4 max-w-sm mx-auto">
          ...
          {showAddForm && (
            <div
              className={`fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 transition-all duration-300 ${isClosing ? 'opacity-0' : 'opacity-100'}`}
              onClick={handleCloseForm}
            >
              <div
                className={`bg-white rounded-2xl w-full max-w-sm shadow-2xl transform transition-all duration-300 ease-out ${
                  isClosing
                    ? 'scale-95 opacity-0'
                  ...
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-xl border border-blue-100">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Use this address for future orders</p>
                      </div>
                    </div>
