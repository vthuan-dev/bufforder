          ...
          {isLoading ? (
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6">
                <h2 className="text-xl font-bold text-white mb-2">Saved Addresses</h2>
                <p className="text-blue-100">Manage your delivery addresses</p>
              </div>

              <div className="p-6 space-y-4">
                {addresses.map((address, index) => (
                  <div key={address._id || index} className="bg-gray-50 rounded-xl p-4 border border-gray-200 hover:shadow-md transition-all duration-200">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm mt-1">Add your first address below</p>
              </div>
            </div>
          )}
            ...
            >
              ...
              >
                ...
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 rounded-t-2xl">
                  <h3 className="text-xl font-bold text-white mb-2">Add New Address</h3>
                  <p className="text-blue-100">Fill in your shipping details below</p>
                </div>
