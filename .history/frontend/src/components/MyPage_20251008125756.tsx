      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="p-6 space-y-6">
          ...
          {showAddForm && (
            ...
            >
              <div
                className={`bg-white rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto transition-all duration-300 ${isClosing ? 'animate-out zoom-out-95 slide-out-to-bottom-2' : 'animate-in zoom-in-95 slide-in-from-bottom-2'}`}
